...
public interface BadWords {
    List<String> koreaWord1 = Arrays.asList("ㅅㅂ", "씨발", "씨바", "개세끼", "18년", "18놈", "18새끼", "ㄱㅐㅅㅐㄲl", "개ㅅㅐ끼", "개새ㄲㅣ", "개새ㄲ1","ㄱㅐㅈㅏ", "가슴만져", "가슴빨아", "가슴빨어", "가슴조물락", "가슴주물럭", "가슴쪼물딱",
            ...
            "후장", "후장꽂아", "후장뚫어", "흐접", "흐젚", "흐졉", "bitch", "fuck", "fuckyou", "nflavor", "penis", "pennis", "pussy", "sex", "ㅅ1발", "ㅅㅣ발", "ㅅl발", "7 H ^ H 77 I","딲ㄱㅣ딲딲",
            "6◐", "○⑥○", "◎6◎", "☎060", "0⑥0", "108", "10넘", "10놈", "10쎈치", "10쎝치", "10알", "10팔", "10발넘", "10발년", "10발놈", "10발눔", "10밸넘", "10밸놈", "10밸늠", "10버지", "10새끼",
            "10새리", "10쎄끼", "10앨넘", "10앨놈", "10앨늠", "10창", "10챵", "10탱", "10탱아", "10팔년", "10팔놈", "10팔연", "10할년", "10할연", "10JIL", "18놈", "18세끼", "18쎄리", "18쒜끼", "18쒜리",
            "18쒝끼", "18씨끼", "18넘", "18년", "18눔", "18늠", "18쉑끼", "2C팔", "2C8", "4KKASI", "ㄱㅐㄱㅣㄴㅑ", "ㄱㅐ넘", "ㄱㅐ년", "ㄱㅐ놈", "ㄱㅐ늠", "ㄱㅐㅅㅐㄲㅣ", "ㄱㅐㅅㅐ끼", "ㄱㅐ지랄", "ㄱㅐ가",
            "ㄱㅐ눔", "ㄱㅐㅅㅑ", "ㄱㅐ조옷", "ㄱㅐㄱㅏ", "ㄱㅐ새ㄲㅣ", "ㄱㅐ새끼", "ㄱㅣ집애", "ㄱH뇬", "ㄱR슴", "ㄱRㅇR슴", "㉮숨", "가랑이", "가스미", "가아슴", "갈켜줄녀", "갈켜줄여", "강간", "같이자자",
            "개넘", "개년", "개놈", "개뇽", "개눔", "개늠", "개라슥", "개ㅅㅐㄲㅣ", "개새끼", "개새야", "개색", "개색기", "개색끼", "개샛키", "개샛끼", "개샤끼", "개샤킥", "개샥", "개섹", "개섺", "개셃", "개스키아",
            "띠발", "띠발롬아","띠발스키아", "띠발놈아", "띠발시키아", "새키", "새끼", "스발", "뷁", "띱때끼", "띱떼끼", "시브럴", "ㅅ1발", "개새ㄲ1","ㅁ1친놈", "씨댕", "쓰댕", "존1나", "존11나", "존111나");
}